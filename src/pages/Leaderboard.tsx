    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">Ranked by XP from achievements unlocked</p>
        ...
        {filteredPlayers.length >= 3 && (
          <div className="grid grid-cols-3 gap-4 max-w-4xl mx-auto">
            ...
            <Card className="p-6 bg-gradient-to-br from-gray-400/10 to-card border-gray-400/30 text-center mt-8">
              ...
              <Badge className="bg-primary/20 text-primary">{filteredPlayers[1].xp?.toLocaleString()} XP</Badge>
            </Card>
            ...
            <Card className="p-6 bg-gradient-to-br from-yellow-500/20 to-card border-yellow-500/50 text-center shadow-gold">
              ...
              <Badge className="bg-primary/20 text-primary text-lg">{filteredPlayers[0].xp?.toLocaleString()} XP</Badge>
            </Card>
            ...
            <Card className="p-6 bg-gradient-to-br from-orange-600/10 to-card border-orange-600/30 text-center mt-8">
              ...
              <Badge className="bg-primary/20 text-primary">{filteredPlayers[2].xp?.toLocaleString()} XP</Badge>
            </Card>
          </div>
        )}
            ...
            <table className="w-full">
              ...
              <tbody>
                {displayedPlayers.map((player) => {
                  const levelInfo = getLevelInfo(player.level || 1);
                  return (
                    <tr
                      key={player.user_id}
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        ...
                        >
                          Lv.{player.level} {levelInfo.name}
                        </Badge>
                      </td>
                      <td className="px-6 py-4 text-right">
                        <span className="font-bold text-lg text-primary">{player.xp?.toLocaleString()}</span>
                      </td>
                    </tr>
                  );
                })}
